	...
	return (
		<Modal visible={visible} onRequestClose={onRequestClose}>
			<Form method="post" id="create-vacation-form">
				<ModalHeader title="Create New Vacation" closeAccessibilityLabel="Close" onBackButtonClick={onRequestClose} />
				<ModalBody tabIndex={0}>
					<VStack gap={3}>
						<TextInput name="year" label="Year" type="number" min={currentYear} value={year} onChange={(e) => setYear(e.target.value)} required />
						{actionData?.error && (
