-- Scenario 4: New vacation (2026), 2 proposals (Tester Two + Three, waiting for Tester One)
...
-- Insert proposal from Tester Three (id: 3)
INSERT INTO proposal (
  id,
  user_id,
  destination_name,
...
-- Link proposals to vacation cycle
